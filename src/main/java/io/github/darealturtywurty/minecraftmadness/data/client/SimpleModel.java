...
/**
 * Generates Parent + Texture Block Model JSON.
 * 
 * @author Commoble
 */
public class SimpleModel {
	public static final Codec<SimpleModel> CODEC = RecordCodecBuilder
			.create(instance -> instance.group(Codec.STRING.fieldOf("parent").forGetter(SimpleModel::getParent),
					Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("textures", ImmutableMap.of())
							.forGetter(SimpleModel::getTextures))
